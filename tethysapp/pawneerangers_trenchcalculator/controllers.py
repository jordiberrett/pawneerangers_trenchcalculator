...
def map_view(request):
    ...
    return render(request, 'pawneerangers_trenchcalculator/map_view.html', context)
...
def map_view_buffer(request):
    ...
    return render(request, 'pawneerangers_trenchcalculator/map_view_buffer.html', context)
...
def map_view_slope(request):
    ...
    return render(request, 'pawneerangers_trenchcalculator/map_view_slope.html', context)
